...
@section('content')
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <span>
                                    ...
                                    <a href="{{ route('syncCustomersFromZoho') }}"
                                        class="btn btn-primary {{ $shouldEnableSync ? '' : 'disabled pointer-events-none opacity-50' }}">
                                        Sync From Zoho
                                    </a>
                                </span>
                            </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-hover" id="customerResponseList"
                                        style="width:100%;">
                                        <thead>
                                            <tr>
                                                <th>S.no</th>
                                        ...
                                        <tbody id="customerList">
                                            ...
                                            @foreach ($customers as $item)
                                                <tr data-id="{{ $item->id }}">
                                                    ...
                                                    <td>
                                                        {{-- <a href="@can('manage customers') {{ role_base_url("
                                                            customer/".$item->id."/edit") }} @endcan" class="btn btn-warning
                                                            btn-sm"><i class="far fa-edit"></i> Edit</a> --}}
                                                        <button type="button" class="btn btn-warning btn-sm ajax-edit-btn"
                                                            data-id="{{ $item->id }}" data-modal-id="editCustomerModal">
                                                        ...
                                                        <form action="{{ url('customer/' . $item->id) }}" method="POST"
                                                            ...
                                                            <button type="submit"
                                                                class="btn btn-danger delete-confirm btn-sm"><i
    ...
    <div class="modal fade" id="customerModal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-xl" role="document">
            <form class="ajax-form" data-url="{{ url('/customer') }}" data-target-table="#customerResponseList"
                data-render-function="renderCustomerRow" data-modal-id="customerModal" id="yourForm">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" value="104137158200003" name="trn_no"
    ...
    <div class="modal fade" id="editCustomerModal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-xl" role="document">
            <form id="customerEditForm" method="POST" class="ajax-update-form" data-url="{{ url('/customer') }}/:id"
                data-fetch-url="{{ url('get-customer-for-edit-form/:id') }}" data-target-table="#customerResponseList"
                data-render-function="renderCustomerRow" data-modal-id="editCustomerModal"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" value="{{ old('trn_no') }}" name="trn_no"
                                                    class="form-control trn_no" required>
                                            </div>
                                        </div>
                            ...
                            <div class="col-12 col-md-6 col-lg-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <label>Address <span class="text-danger">*</span></label>
                                            <textarea name="address" cols="30" class="form-control" rows="10"
