                        ...
                        <tbody>
                          @php $number=1; @endphp
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href='{{ url("admin/investor/".$item->id."/edit") }}' class="btn btn-warning btn-sm"><i class="far fa-edit"></i>Edit</a>
                                    <form action="{{ url('admin/investor/'.$item->id) }}" method="POST" style="display:inline;" class="delete-form">
                                        @csrf
                                        @method('DELETE')
