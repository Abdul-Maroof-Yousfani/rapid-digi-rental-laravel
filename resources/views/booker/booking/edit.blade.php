                  ...
                  <div class="card">
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" value="" name="booker_name" class="form-control">
                      ...
                      <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" value="" name="cnic" class="form-control cnic">
                        </div>
              ...
              <div class="col-12 col-md-6 col-lg-6">
                  ...
                  <div class="card-body">
                      <div class="form-group">
                        ...
                        <input type="date" value="" name="dob" class="form-control datemask" placeholder="YYYY/MM/DD">
                      ...
                      <div class="form-group">
                          ...
                          <input type="text" value="" name="postal_code" class="form-control postal_code">
                      </div>
