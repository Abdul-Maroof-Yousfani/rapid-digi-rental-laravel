                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-striped text-center">
                                        ...
                                        <tbody class="ui-sortable" id="booking_detail"></tbody>
                                        <tr>
                                            <td colspan="8" class="text-center font-weight-bold ">Payment Management</td>
                                        </tr>
                                        <tr>
                                            <td colspan="7" class="text-right align-middle">
                                                <span data-toggle="tooltip" title="The initial deposit amount available">Deposit Amount</span>
                                            </td>
                                            <td>
                                                <input type="number" name="initial_deposit" class="form-control initial_deposit" placeholder="0.00" readonly>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="number" class="form-control remaining_deposit" placeholder="0.00" readonly>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="7" class="text-right align-middle">
                                        ...
                                        <tr id="invoice_adjustment_section1" style="display: none;">
                                            ...
                                            <td>
                                                <input type="text" class="form-control reference_invoice_number" name="reference_invoice_number[]" placeholder="Enter invoice number">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="7" class="text-right align-middle">Remarks (Optional)</td>
                                            <td>
                                                <textarea name="remarks[]" class="form-control" placeholder="e.g., Payment for invoice #123, special instructions" rows="4" style="resize: vertical;"></textarea>
                                            </td>
                                        </tr>
                                        <!-- </tbody> -->
