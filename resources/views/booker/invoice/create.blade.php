...
<tr>
    <td class="align-middle"><br>
        <div class="form-group">
            <select name="invoice_type[]" class="form-control select2 invoice_type" data-name-field="invoice_type_name[]" onchange="setInvoiceTypeName(this)">
                <option value="">Select Invoice type</option>
                @foreach ($invoiceTypes as $dtype)
                <option value="{{ $dtype->name }}">{{ $dtype->name }}</option>
                @endforeach
            ...
            <input type="hidden" name="invoice_type_name[]" class="invoice_type_name">
