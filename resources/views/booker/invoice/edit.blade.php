                                        ...
                                        <tbody id="vehicleTableBody">
                                            ...
                                            <tr>
                                                ...
                                                <td class="align-middle"><br>
                                                    <div class="form-group">
                                                       <input type="date" value="{{ $item->start_date ? \Carbon\Carbon::parse($item->start_date)->format('Y-m-d') : '' }}" name="booking_date[]" class="form-control datemask" placeholder="YYYY-MM-DD">
                                                    </div>
                                                </td>
                                                <td class="align-middle"><br>
                                                    <div class="form-group">
                                                        <input type="date" value="{{ $item->end_date ? \Carbon\Carbon::parse($item->end_date)->format('Y-m-d') : '' }}" name="return_date[]" class="form-control datemask" placeholder="YYYY-MM-DD">
                                                    </div>
                                                </td>
                                                <td class="align-middle"><br>
                                                    <div class="form-group">
        ...
        $('#addRow').click(function() {
            let newRow = `
                <tr>
                    ...
                    <td class="align-middle"><br>
                        <div class="form-group">
                            <input type="text" value="" name="price[]" class="form-control price" >
                        </div>
                    </td>
                    <td class="align-middle"><br>
                        <div class="form-group">
