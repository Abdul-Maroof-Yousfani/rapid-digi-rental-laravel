            ...
            <div class="section-body">
                ...
                <form method="get" id="customerWiseReceivableReportForm" class="mb-4">
                    <div class="form-row align-items-end">
                        ...
                        {{-- <div class="col-md-4 text-right d-flex flex-column gap-2 mt-4">
                            <button type="button" class="btn btn-success w-100 mb-2" onclick="exportToExcel('customer_wise_receivable', 'customerWiseReceivableReportForm')">
                        ...
                        <div class="col-md-4 text-right">
                            <button class="btn btn-success" onclick="exportToExcel('customer_wise_receivable', 'customerWiseReceivableReportForm')" style="">
