            ...
            <div class="section-body">
                ...
                <div class="print-heading">
                    <h2 style="text-align: center; text-decoration: underline; font-weight: bold;">
                        Statement of Account for the month of <span class="filterTillDateMonth"></span> <span
                            class="filterTillDateYear"></span>
                    </h2>
                    ...
                    <p>
                        ...
                        LLC.
                        As for the month till <span class="filterTillDate"></span> we have rented your vehicles and the
                ...
                <table class="print-footer-table">
                    ...
                    <tr>
                        <td class="footer-table-data-head">Amount after service fee deduction <span
                                class="agreePercentage"></span>%</td>
